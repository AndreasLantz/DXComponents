...
import StyledPegaExtensionsNetworkDiagramExtended from './styles';
...
export interface NetworkDiagramPropsExtended {
...
export const PegaExtensionsNetworkDiagramExtended = (props: NetworkDiagramPropsExtended) => {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <StyledPegaExtensionsNetworkDiagramExtended height={height} theme={theme}>
          <ReactFlowProvider>
            <Flow {...props} counter={counter} />
          </ReactFlowProvider>
        </StyledPegaExtensionsNetworkDiagramExtended>
      </CardContent>
    </Card>
  );
};
export default withConfiguration(PegaExtensionsNetworkDiagramExtended);
