...
import { PegaExtensionsNetworkDiagramExtended, type NetworkDiagramPropsExtended } from './index';

export default {
  title: 'Widgets/Visualizer',
  argTypes: {
    Example: {
  ...
  component: PegaExtensionsNetworkDiagramExtended
};
...
interface VisualizerPropsExt extends NetworkDiagramPropsExtended {
  Example: string;
}

type Story = StoryObj<VisualizerPropsExt>;
export const Default: Story = {
  render: (args: VisualizerPropsExt) => {
    ...
    return <PegaExtensionsNetworkDiagramExtended {...props} />;
  },
  args: {
    Example: 'example1',
    heading: 'Heading',
